...
namespace matriz.Forms
{
    public partial class Producto : Form
    {
        ...
        private void producto()
        {
            ...
            //fila 1
            sra1 = (a1 * Ba1) + (a2 * Bb1) + (a3 * Bc1);    //posicion1
            sra2 = (a1 * Ba2) + (a2 * Bb2) + (a3 * Bc2);    //posicion2
            sra3 = (a1 * Ba3) + (a2 * Bb3) + (a3 * Bc3);    //posicion3
            //fila 2
            srb1 = (b1 * Ba1) + (b2 * Bb1) + (b3 * Bc1);    //posicion4
            srb2 = (b1 * Ba2) + (b2 * Bb2) + (b3 * Bc2);    //posicion5
            srb3 = (b1 * Ba3) + (b2 * Bb3) + (b3 * Bc3);    //posicion6
            //fila 3
            src1 = (c1 * Ba1) + (c2 * Bb1) + (c3 * Bc1);    //posicion7
            src2 = (c1 * Ba2) + (c2 * Bb2) + (c3 * Bc2);    //posicion8
            src3 = (c1 * Ba3) + (c2 * Bb3) + (c3 * Bc3);    //posicion9
        }
