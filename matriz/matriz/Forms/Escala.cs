...
namespace matriz.Forms
{
    public partial class Escala : Form
    {
        ...
        private void txtBA1_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }

        private void txtBA2_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }

        private void txtBA3_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }

        private void txtBB1_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }

        private void txtBB2_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }

        private void txtBB3_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }

        private void txtCC1_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }

        private void txtCC2_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }

        private void txtCC3_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }

        private void ResA1_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }

        private void ResA2_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }
        ...
        private void ResB1_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }

        private void ResB2_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }

        private void ResB3_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }

        private void ResC1_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }

        private void ResC2_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }
        ...
        private void aleatorio()
        {
            ...
            txbValor1.Text = Convert.ToString(rnd.Next(-100, 100));
            txbValor2.Text = Convert.ToString(rnd.Next(-100, 100));
        }
        ...
        private void txbA2_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }

        private void txbA1_KeyPress(object sender, KeyPressEventArgs e)
        {
            BloqueaNum(e);
        }
        ...
        private void btnBorra_Click_1(object sender, EventArgs e)
        {
            limpiar();
        }
        ...
        private void Convertir()
        {
            ...
            Bc3 = Convert.ToInt32(txtCC3.Text);
             ...
             val1 = Convert.ToInt32(txbValor1.Text);
             val2 = Convert.ToInt32(txbValor2.Text);
        }
        private void Sumas()
        {
            sra1 = (val1 * a1) + (val2 * Ba1);
            sra2 = (val1 * a2) + (val2 * Ba2);
            sra3 = (val1 * a3) + (val2 * Ba3);
            srb1 = (val1 * b1) + (val2 * Bb1);
            srb2 = (val1 * b2) + (val2 * Bb2);
            srb3 = (val1 * b3) + (val2 * Bb3);
            src1 = (val1 * c1) + (val2 * Bc1);
            src2 = (val1 * c2) + (val2 * Bc2);
            src3 = (val1 * c3) + (val2 * Bc3);
        }
